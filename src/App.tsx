...
## 제3조 (개인정보 보호)
서비스는 사용자의 사주 분석을 위해 입력된 정보를 분석 목적으로만 사용하며, 별도의 동의 없이 서버에 영구 저장하거나 제3자에게 제공하지 않습니다.
...
유아이 사주상담(이하 "서비스")은 사용자의 개인정보를 소중히 여기며, 관련 법령을 준수합니다.
...
## 4. 제3자 제공 및 위탁
서비스는 사용자의 동의 없이 개인정보를 외부에 제공하지 않습니다. 단, 서비스 운영을 위해 다음과 같은 외부 플랫폼을 활용할 수 있습니다.
- Google Firebase (인증 및 시스템 운영)
