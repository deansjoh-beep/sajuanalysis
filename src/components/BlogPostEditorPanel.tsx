      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full p-5 min-h-[44px] rounded-2xl bg-white/70 backdrop-blur border border-white/65 focus:ring-2 focus:ring-indigo-500 outline-none font-bold text-xl transition-all"
            value={post.title || ''}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-3">
              ...
              />
              <label className="cursor-pointer px-6 py-5 min-h-[44px] rounded-2xl bg-indigo-500/10 text-indigo-600 font-bold text-xs hover:bg-indigo-500/20 transition-all flex items-center gap-2 border border-indigo-500/20 backdrop-blur">
        ...
        <div className="grid grid-cols-1 gap-6">
          <div className="space-y-2">
            <label className="text-[10px] font-bold uppercase tracking-widest opacity-40 ml-2">SEO 제목 (Meta Title)</label>
            <input
              type="text"
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-bold uppercase tracking-widest opacity-40 ml-2">SEO 설명 (Meta Description)</label>
            <textarea
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-bold uppercase tracking-widest opacity-40 ml-2">OG 이미지 URL</label>
            <input
              type="text"
        ...
        <div className="space-y-2">
          ...
          <div className="prose-editor">
            <Suspense fallback={<div className="text-xs text-zinc-500 px-3 py-2">에디터 불러오는 중...</div>}>
              <LazyBlogRichEditor
                value={post.content || ''}
        ...
        <button
          onClick={onSubmit}
          className="w-full py-5 min-h-[44px] rounded-[1.5rem] bg-indigo-600 text-white font-bold hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-500/20 flex items-center justify-center gap-3 text-lg active:scale-[0.98]"
        >
