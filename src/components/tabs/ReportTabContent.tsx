...
import { ArrowRight, Briefcase, Calendar, Heart, Sparkles } from 'lucide-react';
...
export function ReportTabContent({
  ...
  const products: ProductCardData[] = [
    ...
    },
    {
      ...
      title: '연애·결혼운 가이드북',
      hanja: '戀愛結婚運',
      tagline: '연애와 결혼은 다른 결을 가진다 — 따로 깊이 본다',
      description:
        '연애운(편재·편관·도화)과 결혼운(정재·정관·일지)을 별도 섹션으로 분리해 분석합니다. 작용하는 십성과 시기 단위가 다르기 때문에 한 번에 묶으면 깊이가 사라집니다.',
      bullets: [
        '연애의 결 — 편재·편관 + 도화·홍염, 세운·월운 단위',
        '결혼의 결 — 정재·정관 + 일지(배우자궁), 대운 단위',
        '어울리는 배우자상 — 본인 사주의 결핍을 보완하는 기질',
        '향후 3년 관계 로드맵 + 위기·회복 시기 가늠',
      ],
      price: '5,000원',
      cta: '연애·결혼운 가이드북 주문하기',
      icon: Heart,
        ...
        <div className="max-w-3xl mx-auto space-y-12 md:space-y-16">
          ...
          <header className="text-center space-y-4">
            ...
            <p className="text-[13px] md:text-[15px] text-ink-700 leading-[1.85] max-w-2xl mx-auto">
              ...
              네 가지 프리미엄 리포트는 각각 한 가지 주제를 깊이 다룹니다.
              <br className="hidden md:block" />
